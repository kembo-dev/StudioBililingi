        ...
        *,
        ...
        return self.text.generate_json(
            system=(
                ...
                "apparaître. Respecte genre, sous-genre, cadre géographique/culturel, mode et durée cible. "
                "La somme des target_seconds doit rester proche de episode_duration_seconds. N'ajoute aucune scène de "
