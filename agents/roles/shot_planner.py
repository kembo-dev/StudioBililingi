    ...
    def plan(self, *, beat: dict, durations: list[int], bible: dict | None = None) -> dict:
        return self.text.generate_json(
            system=(
                ...
                "N'inclus du dialogue dans video_prompt que si le beat contient explicitement une réplique; dans ce cas, "
                "reproduis uniquement cette réplique exacte et identifie clairement le personnage qui la prononce. "
                "S'il n'y a aucune réplique dans le beat, le shot doit rester sans parole et sans narration. "
