    ...
    def plan(self, *, beat: dict, durations: list[int], bible: dict | None = None) -> dict:
        return self.text.generate_json(
            system=(
                ...
                "video_prompt est une INSTRUCTION VISUELLE SILENCIEUSE: sujet visible, action précise, réaction, "
                "cadrage/mouvement et continuité. Une description d'action ne doit jamais devenir une phrase prononcée. "
                "AUDIO: narration et dialogue sont deux canaux canoniques distincts. Si narration est présente, "
                "elle appartient uniquement au narrateur externe hors champ. Si dialogue est présent, reproduis uniquement "
                "la réplique exacte et identifie le personnage speaker. Si les deux sont présents, conserve les deux sans "
                "les fusionner ni échanger les voix. S'ils sont tous deux vides, le shot reste sans parole et sans narration. "
                "Préserve strictement les ids et la continuité canonique fournis. "
